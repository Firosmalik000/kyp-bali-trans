    ...
    <section id="contact" className="w-full py-5 px-8 md:px-[100px] flex flex-col md:flex-row bg-gray-100 justify-between gap-x-5">
      <div className="w-full md:w-1/2">
        ...
        <div className="py-8 border-b-2 my-5">
          <p className="text-xl text-center md:text-left font-semibold font-sans">KYP Bali Trans</p>
        </div>

        {/* contact */}
        <div className="flex flex-col md:flex-row gap-y-6 md:gap-x-[100px]">
          <div className="text-center md:text-left">
            <h1 className="text-xl font-bold text-gray-800 font-sans mb-6">{content[language].title}</h1>
            <div className="max-w-lg flex flex-col gap-y-2 mb-8">
              <div className="flex justify-center md:justify-start">
                <FaEnvelope className="mr-2 mt-1 text-yellow-400" /> <p className="">kypbalitrans@gmail.com</p>
              </div>
              <div className="flex justify-center md:justify-start">
                <FaPhone className="mr-2 text-green-600" /> +62-823-4033-2580
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="max-w-lg flex flex-col gap-y-2 text-gray-800 font-sans mb-6 text-center md:text-left">
              <p className="text-xl font-bold text-gray-800 font-sans mb-6">{content[language].follow}</p>
      ...
      <div>
        <div className="">
          <div className="py-8 my-5">
            <p className="text-xl font-semibold font-sans mb-3 text-center md:text-left">{content[language].address}</p>
